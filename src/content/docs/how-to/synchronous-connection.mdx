...
The synchronous client is located under the `glide_sync` module. It's API is similar to the asynchronous client making it interchangeable in most cases with the exception of not having to use  the `await` keyword.
