...
<Tabs syncKey="progLangInExamples">
  ...
  <TabItem label="C#">
    ...
    // Configure the client to invoke the callback for messages published
    // to 'ch1' and 'ch2' and to channels matched by 'chat*' glob pattern.
    var subscriptionConfig = new StandalonePubSubSubscriptionsConfig()
        .WithChannel("ch1")
        .WithChannel("ch2")
        .WithPattern("chat*")
...
<Tabs syncKey="progLangInExamples">
  <TabItem label="Java">
    ...
    StandaloneSubscriptionsConfiguration subscriptionConfig = StandaloneSubscriptionsConfiguration.builder()
