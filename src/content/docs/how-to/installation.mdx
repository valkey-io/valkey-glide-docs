...
Windows support is currently available for Valkey GLIDE Java and C#.

* Windows (x86\_64)
* Windows (arm64) — C# only
...
<Tabs syncKey="progLangInExamples">
  <TabItem label="Python">
    **Requirements:** Python 3.9 to 3.13.
    ...
    To get started, GLIDE Python is available on [pypi](https://pypi.org/project/valkey-glide/).
