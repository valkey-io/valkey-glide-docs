...
This guides will go over how to install Valkey GLIDE for your specific system.
...
Node.js requires `glibc` 2.17+. This should be the standard for GNU Linux based system.
...
<Tabs syncKey="progLangInExamples">
    ...
    **Requirements:** JDK 11+
    ...
    You must include the classifier for your OS. It is recommended to use the [OS Detector](https://github.com/google/osdetector-gradle-plugin) pluggin to 
    detect the correct classifier for your OS. 
    
    Otherwise, the followings specifiers are supported:
    ```
    osx-x86_64
    linux-aarch_64
    linux-x86_64
    ...
    **For npm users on linux it is recommended to use npm >=11**. It support optional download base on libc. Yarn users should not be concerned.
