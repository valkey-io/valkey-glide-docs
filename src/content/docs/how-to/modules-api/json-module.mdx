---
title: JSON Module
description: Learn how to use the JSON module with GLIDE.
---

import { Aside, Tabs, TabItem } from '@astrojs/starlight/components';

For more details on the JSON module, see the [Valkey JSON topic](https://valkey.io/topics/valkey-json/) and the [JSON commands reference](https://valkey.io/commands/#json).
