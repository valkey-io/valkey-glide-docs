---
title: Search Module
description: Learn how to use the Vector Search module with GLIDE.
---

import { Aside, Tabs, TabItem } from '@astrojs/starlight/components';

For more details on the Search module, see the [Valkey Search topic](https://valkey.io/topics/search/) and the [Search commands reference](https://valkey.io/commands/#search).
