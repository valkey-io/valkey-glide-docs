...
<Tabs syncKey="progLangInExamples">
  ...
  <TabItem label="Ruby">
    :::note
    The Search (vector) module is not yet available in the Ruby client. Support is tracked upstream in the [valkey-glide-ruby](https://github.com/valkey-io/valkey-glide-ruby) repository.
    :::
  </TabItem>
</Tabs>
