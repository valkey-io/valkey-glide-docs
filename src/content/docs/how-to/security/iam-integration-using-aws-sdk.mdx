---
title: AWS IAM Integration Using AWS SDK
...
See the <a href="/concepts/client-features/aws-iam-auth-with-glide">IAM Authentication with GLIDE</a> guide for a detailed explanation.
:::
