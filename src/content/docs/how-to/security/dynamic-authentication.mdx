...
This feature is particularly useful for scenarios where passwords need to be rotated regularly to maintain secure connections. 
...
When dynamically switching to a new credential, ensure that it has enough permissions to run connection startup commands. See the [ACL Permissions Requirements](/how-to/security/access-control) for more details.
:::
