...
description: Guide for integrating Valkey GLIDE with AWS IAM for secure authentication.
---
...
This section shows how to utilize the AWS SDK for the IAM token generation.
...
```
  ...
  <TabItem label="Go">
    :::note
    IAM authentication for Go is not yet supported.
    :::
  </TabItem>
</Tabs>
