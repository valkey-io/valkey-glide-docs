...
See the <a href={`${import.meta.env.BASE_URL}/concepts/client-features/aws-iam-auth-with-glide/#iam-authentication-using-aws-sdk`}>IAM Authentication with GLIDE</a> section for a detailed explanation about using IAM authentication with GLIDE.
