...
Development instructions for local building & testing the package are in the <a href={`${import.meta.env.BASE_URL}/languages/nodejs/developer`}> developer</a> section.
