...
See the <a href={`${baseUrl}/concepts/client-features/dynamic-authentication/#acl-permissions-requirements`}>Dynamic Authentication</a> section for a detailed explanation about using ACLs with GLIDE.
