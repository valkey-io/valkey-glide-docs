...
For more on advanced configurations, refer to the <a href={`${import.meta.env.BASE_URL}/languages/python`}>Python GLIDE Guide</a>.

### Comparison: Standalone Mode

<Tabs>
  <TabItem label="redis-py">
    ```python
    import redis
...
### Constructor Parameter Comaprison
