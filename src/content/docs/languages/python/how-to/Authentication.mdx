...
See the <a href={`${import.meta.env.BASE_URL}/concepts/client-features/aws-iam-auth-with-glide`}>IAM Authentication with GLIDE</a> section for a detailed explanation.
