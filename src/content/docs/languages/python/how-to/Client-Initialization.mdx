...
Valkey GLIDE provides support for both [Cluster](#cluster) and [Standalone](#standalone) configurations.
Please refer to the relevant section based on your specific setup.
