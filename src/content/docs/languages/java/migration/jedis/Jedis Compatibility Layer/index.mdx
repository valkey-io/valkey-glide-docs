...
Ready to get started?
  <LinkCard 
    ...
    href={`${import.meta.env.BASE_URL}/languages/java/migration/jedis/jedis-compatibility-layer/instructions/`} 
    description="Step-by-step instructions for migrating using the Jedis Compatibility Layer."/>
  <LinkCard 
    title="Supported Features" 
    href={`${import.meta.env.BASE_URL}/languages/java/migration/jedis/jedis-compatibility-layer/supported-features`} 
    description="See how Jedis commands and configurations are supported."/>
  <LinkCard 
    title="Configuration Mapping" 
    href={`${import.meta.env.BASE_URL}/languages/java/migration/jedis/jedis-compatibility-layer/configurations-mapping`} 
