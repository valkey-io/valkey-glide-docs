...
Refer to the <a href={`${import.meta.env.BASE_URL}/reference/compatibility/platform-support`}>platform support</a> section for details.

## Prerequisites

<Aside>
  For developers, please refer to Java's <a href={`${import.meta.env.BASE_URL}/languages/java/developer`}>developer guide</a> for further instruction on how to set up your development environment.
</Aside>
