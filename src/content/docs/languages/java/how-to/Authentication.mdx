...
See the <a href={`${import.meta.env.BASE_URL}/concepts/client-features/using-iam-authentication-with-glide-for-elasticache-and-memorydb`}>IAM Authentication with GLIDE</a> section for a detailed explanation about using IAM authentication with GLIDE.
