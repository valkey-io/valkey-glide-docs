...
Ready to get started?
  <LinkCard 
    ...
    href={`/migration/java/jedis/jedis-compatibility-layer/instructions/`} 
    description="Step-by-step instructions for migrating using the Jedis Compatibility Layer."/>
  <LinkCard 
    title="Supported Features" 
    href={`/migration/java/jedis/jedis-compatibility-layer/supported-features`} 
    description="See how Jedis commands and configurations are supported."/>
  <LinkCard 
    title="Configuration Mapping" 
    href={`/migration/java/jedis/jedis-compatibility-layer/configurations-mapping`} 
