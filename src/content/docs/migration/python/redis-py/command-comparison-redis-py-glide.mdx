...
:::tip
See <a href={`/languages/python/migration/redis-py/command-comparison-chart`}>comprehensive comparison chart</a> for common Redis commands and how they are implemented in both Jedis and Glide.
:::
