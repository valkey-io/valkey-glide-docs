...
GLIDE also support Valkey Functions, an alternative approach scripting.
See our [guide](/how-to/execute-custom-scripts-and-functions/) on how to use Valkey Functions with GLIDE.
