...
descriptions: Lean about GLIDE's transaction API.
---

:::caution[Deprecated]
Starting with GLIDE 2.0, the Transaction API has be superseded by the [Batch API](/concepts/client-features/batch-commands/).
:::
