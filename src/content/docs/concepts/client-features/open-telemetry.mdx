...
:::note
Some advanced commands have limited or no tracing instrumentation:

* The SCAN family of commands (SCAN, SSCAN, HSCAN, ZSCAN) — not yet traced in any client.
* Lua scripting commands — EVALSHA is now traced in the **Python client**.

Support for SCAN family tracing will be added in a future version as we continue to expand coverage.
:::
