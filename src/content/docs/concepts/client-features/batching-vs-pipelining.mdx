...
* <a href={`${baseUrl}/languages/python/features/batch-transaction-and-pipelining`}> Python wrapper - Batch: Transaction and Pipelining </a>
* <a href={`${baseUrl}/languages/nodejs/features/batch-transaction-and-pipelining`}> NodeJS wrapper - Batch: Transaction and Pipelining </a>
* <a href={`${baseUrl}/languages/java/features/batch-transaction-and-pipelining`}> Java wrapper - Batch: Transaction and Pipelining </a>
* <a href={`${baseUrl}/languages/golang/features/batch-transaction-and-pipelining`}> Golang wrapper - Batch: Transaction and Pipelining </a>
