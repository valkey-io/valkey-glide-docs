...
<Aside title="Reusing Your Connections">
  GLIDE clients are designed to be long-lived.
  You can create a connection and reuse it throughout your applications to avoid unnecessary overheads.
</Aside>
