...
<a href={`${import.meta.env.BASE_URL}/getting-started/tutorials/lua-scripting/lua-scripting-atomic-non-primitives`}>next</a> tutorial.
...
<LinkCard title="Atomic Non-Primitive Operations" 
    ...
    href={`${import.meta.env.BASE_URL}/getting-started/tutorials/lua-scripting/lua-scripting-atomic-non-primitives`}
/> 
