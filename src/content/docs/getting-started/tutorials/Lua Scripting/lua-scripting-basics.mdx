...
<LinkCard title="Atomic Non-Primitive Operations" 
    description="A realistic example of how Lua scipting ensures atomicity between operations."
    href={`/getting-started/tutorials/lua-scripting/lua-scripting-atomic-non-primitives`}
/> 
