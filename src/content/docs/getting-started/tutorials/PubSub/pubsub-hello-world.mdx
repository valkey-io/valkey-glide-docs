...
<Steps> 
    ...
    4. **Create Clients and Publish a Message**
        ...
        A best practice with Pub/Sub is to use a **dedicated client for your subscriptions**. 
        A client in subscription mode is only focused on listening and cannot run other commands. 
        GLIDE enforces this by having you define subscriptions when you create the client.
