...
This section will go over some of the basics of GLIDE like how to send commands to Valkey.

## Understanding GLIDE clients.

To communicate with Valkey, GLIDE clients provide methods for users to send commands to Valkey.
Under the hood, all clients share a common same Rust core to communicate with Valkey. This
makes their behavior consistent between the different languages while still supporting language
specific features.

<Aside>
  To find more infomation on the Rust core that power GLIDE clients, see [here](../../concepts/architecture/architecture/).
</Aside>
...
Clients can send [MSET](https://valkey.io/commands/mset/) and [MGET](https://valkey.io/commands/mget/) commands, which is used to perform operations in batch atomically.
...
Now that you've understand the basics, take a look at other topics on Valkey GLIDE:

<LinkCard title="Tutorials" href="../tutorials/caching-app" description="Continue with a tutorial on building a simple caching layer." />

<LinkCard title="How-To" href="../../how-to" description="Visit the how-to section to get started on advanced guides on different topics on Valkey." />

<LinkCard title="Concepts" href="../../concepts" description="Learn more about Valkey Glide features and concepts." />

<LinkCard title="Languages" href="../../languages" description="Take a look at language specific documentations." />
