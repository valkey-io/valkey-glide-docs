...
<LinkCard title="GLIDE's Rust Core" href={`${baseUrl}/concepts/architecture/rust-core-design`} description="Learn more about the underlying engine that connects GLIDE drivers." />

<LinkCard title="Languages" href={`${baseUrl}/languages`} description="For language specific instructions, take a look at our supported languages." />
