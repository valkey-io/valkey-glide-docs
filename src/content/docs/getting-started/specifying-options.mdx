...
GLIDE offers many configuration options. A typical configuration options may look like following:
...
<Aside title="More Options">
  A full list of connection options can be found [here](/).
</Aside>
