...
GLIDE offers many configuration options to handle to Valkey through its configuration object. 
...
:::tip
For a full list of connection options, take a look at the <a href={`/reference/configuration/connection-options`}>connection options</a> reference.
:::
